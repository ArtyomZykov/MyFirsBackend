...
data class ApplicationFirmDomain(
    var name: String,
...
object ApplicationFirm : IntIdTable("application_firms") {
    ...
    var Status = enumeration("status", nstu.ru.api.domain.enum.Status::class)
}

fun ApplicationFirm.fromRow(resultRow: ResultRow): ApplicationFirmDomain =
    ApplicationFirmDomain(
        resultRow[Name],
